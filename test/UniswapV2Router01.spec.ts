...
enum RouterVersion {
  ...
  UnioracleV2Router01 = 'UnioracleV2Router01'
}
  ...
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        ...
        [RouterVersion.UnioracleV2Router01]: fixture.oracleRouter03
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.UniswapV2Router01]: 102320,
              [RouterVersion.UnioracleV2Router01]: 266234
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.UniswapV2Router01]: 139274,
              [RouterVersion.UnioracleV2Router01]: 303198
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
